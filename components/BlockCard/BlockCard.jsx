    ...
    return (
        ...
        >
            ...
            <div className="flex flex-row items-center justify-between p-2 rounded-md bg-hover font-noto-sans">
                <a href={blockData.link} className="overflow-hidden">{blockData.link}</a>
                <div 
                onClick={handleCopyIconClick} 
                >
                    <HtmlTooltip title={
                        <p className="text-lg">{copyText}</p>
                    }
                    arrow 
                    placement="top">
                        <span 
                        className="p-1 text-3xl rounded-lg cursor-pointer material-icons hover:bg-block"
                        >content_copy
                        </span>
                    </HtmlTooltip>
                </div>
