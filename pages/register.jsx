          ...
          <div className="flex flex-col items-center justify-between h-auto p-10 m-4 text-center text-white rounded lg:m-0 lg:w-1/2 bg-sidebar">
            ...
            <div className="flex flex-col items-center justify-around w-full space-y-4 ">
              <TextField
                ...
                helperText={
                  credentials.email === "" && !credentials.initial
              ...
              <TextField
                ...
                helperText={
                  credentials.username === "" && !credentials.initial
              ...
              <TextField
                ...
                helperText={
                  credentials.password.length <= 8 && !credentials.initial
              ...
              <div className="space-x-2 frc">
                ...
                />
                <h3 className="text-base text-coal lg:text-xl">
                  I agree to the{" "}
                  <a
                    className="underline"
